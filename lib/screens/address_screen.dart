...
import 'package:onlala_shopping/screens/edit_address_screen.dart';
...
class _AddressScreenState extends State<AddressScreen> {
  ...
  Future<void> getAddresses() async {
    ...
    final url =
        'https://onlala-api.herokuapp.com/business/buyer/postal_address';
    try {
...
class _AddressCardState extends State<AddressCard> {
  ...
  Future<void> deleteAddress(String id) async {
    ...
    final url =
        'https://onlala-api.herokuapp.com/business/buyer/postal_address/delete/';
    try {
